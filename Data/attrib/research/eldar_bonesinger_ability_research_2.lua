...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$96362]] -- - Allows Webway Assembly to use Bonesong.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$96363]] -- - All buildings near the cast area temporarily become nearly invulnerable to damage.
