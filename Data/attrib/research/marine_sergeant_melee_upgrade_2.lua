...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$95262]] -- - Equips all Sergeants with Power Fists, powerful close combat weapons.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$95263]] -- - Power Fists ignore armor and greatly increase the user's strength.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$95264]] -- - Power Fists are effective against most unit types, including vehicles, infantry, and heavy infantry.
