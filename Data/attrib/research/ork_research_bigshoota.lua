...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$95822]] -- - Increases damage dealt by all Big Shootas, available on Ork squads and on turrets and vehicles.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$95823]] -- - First of two possible upgrades.
