...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$96202]] -- - Upgrades Howling Banshee Exarch's Power Sword to the more powerful Executioner.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$96203]] -- - Allows the use of the War Shout ability.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$96204]] -- - When triggered War Shout does massive morale damage to any enemies nearby.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$96205]] -- - Provides a speed bonus when charging into close combat.
