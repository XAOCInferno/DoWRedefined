...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$96413]] -- - When active, Infiltrating units are invisible to most enemies.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$96414]] -- - Infiltrated units cannot attack until Infiltration is turned off.
