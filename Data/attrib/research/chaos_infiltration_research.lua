...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$95452]] -- - Allows Cultists and Chaos Space Marines to use the Infiltration ability.
...
GameData["ui_info"]["screen_name_id"] = [[$95450]] -- Infiltration Skill
