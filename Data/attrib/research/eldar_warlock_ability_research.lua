...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$96252]] -- - All Warlocks gain the Conceal ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$96253]] -- - This ability causes the squad the Warlock is with to take less damage from ranged attacks.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$96254]] -- - Once researched this ability is always on.
...
GameData["ui_info"]["screen_name_id"] = [[$96250]] -- Imbue: Conceal
