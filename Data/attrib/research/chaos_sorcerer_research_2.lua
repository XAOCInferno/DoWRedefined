...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$95592]] -- - Allows the Sorcerer to use the Corruption ability.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$95593]] -- - Corruption temporarily taints an area. Corrupted areas deal damage to any units passing through them.
...
GameData["ui_info"]["screen_name_id"] = [[$95590]] -- Corruption Research
