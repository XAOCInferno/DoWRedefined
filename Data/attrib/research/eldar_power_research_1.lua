...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$96292]] -- - Provides a global bonus to Power resource production rates.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$96293]] -- - Perform this research if you have an excess of Requisition but not enough Power.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$96294]] -- - First of two possible upgrades.
...
GameData["ui_info"]["screen_name_id"] = [[$96290]] -- Strengthen Power Grid Research
