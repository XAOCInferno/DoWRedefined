...
GameData["cost_ext"]["time_cost"]["time_seconds"] = 185
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94222]] -- - Chaos Headquarters building.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94223]] -- - Produces: Heretics and Cultists.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94224]] -- - Contains research to increase the number of units that can be built.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$94225]] -- - Projects a Control Area around itself, allowing other buildings to be built near it.
