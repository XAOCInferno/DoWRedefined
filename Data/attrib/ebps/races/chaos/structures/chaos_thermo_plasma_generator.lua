...
GameData["cost_ext"]["time_cost"]["cost"]["requisition"] = 495
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94282]] -- - Generates the Power resource at a higher rate than Plasma Generators.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94283]] -- - Can only be built on top of Slag Deposits.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94284]] -- - Thermo Plasma Generators are volatile and will damage anything nearby when they are destroyed.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$94280]] -- Thermo Plasma Generator
