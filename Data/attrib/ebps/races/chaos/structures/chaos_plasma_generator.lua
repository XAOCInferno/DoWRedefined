...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94252]] -- - Generates the Power resource.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94253]] -- - A single HQ building (Desecrated Stronghold) can only support a limited number of Generators.
