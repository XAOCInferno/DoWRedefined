...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94312]] -- - Mine Fields contain mines that will explode when enemy units pass over them.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94313]] -- - Mine Fields cannot be seen by most enemy units.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94314]] -- - Once detected, enemies can attack and destroy Mine Fields.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$94315]] -- - After enough mines are triggered the Mine Field will be destroyed.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$94310]] -- Mine Field
