...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$97392]] -- - Heavy Infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$97393]] -- - Leader Unit effective at close combat and boosting squad morale.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$97394]] -- - Can be upgraded with powerful close combat weapons (Chaos Armory).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$97395]] -- - Can use Berserk Fury ability to boost attack damage and morale.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$97396]] -- - Effective against Infantry.
