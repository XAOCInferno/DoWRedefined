...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$97252]] -- - Heavy Infantry.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$97253]] -- - Resilient general combat unit strong at ranged and close combat.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$97254]] -- - Broad range of weapon upgrades. Can be upgraded to be strong against most unit types.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$97255]] -- - Can be upgraded with Infiltration (stealth).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$97256]] -- - Effective against Infantry.
