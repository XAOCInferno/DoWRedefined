...
GameData["health_ext"]["pre_death_event_delay"] = 2.069999933
...
GameData["requirement_ext"]["requirements"]["required_1"]["population_required"] = 16
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94402]] -- - Generates the Power resource at a higher rate than Generators.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94403]] -- - Can only be built on top of Slag Deposits.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94404]] -- - Bigga Generators are volatile and will damage anything nearby when they are destroyed.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$94400]] -- Bigga Generator
