...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94052]] -- - Space Marine Headquarters building.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94053]] -- - Produces: Servitors and Scouts.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94054]] -- - Contains research to increase the number of units that can be built.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$94055]] -- - Projects a Control Area around itself, allowing other buildings to be built near it.
