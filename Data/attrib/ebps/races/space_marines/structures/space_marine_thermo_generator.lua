...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$94072]] -- - Generates the Power resource at a higher rate than Plasma Generators.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$94073]] -- - Can only be built on top of Slag Deposits.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94074]] -- - Thermo Plasma Generators are volatile and will damage anything nearby when they are destroyed.
...
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$94070]] -- Thermo Plasma Generator
