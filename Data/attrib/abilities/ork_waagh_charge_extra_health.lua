...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 1.019999981
...
GameData["requirements"]["required_1"]["mobvalue_required"] = 5
GameData["requirements"]["required_1"]["proximity_required"] = 25
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$92132]] -- - Orks receive benefits from massing together, the more Orks the better.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92133]] -- - Mob Level 3 makes all affected Orks immune to morale damage.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$92134]] -- - All affected units also receive a bonus to attack damage.
...
GameData["ui_info"]["screen_name_id"] = [[$92130]] -- Ork Mob Level 3
