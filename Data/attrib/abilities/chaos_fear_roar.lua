...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["morale_damage"] = 1500
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$673200]] -- - Lets out a fearsome roar, which breaks the morale of nearby enemies.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$673202]] -- - Left-click to activate.
...
GameData["ui_info"]["screen_name_id"] = [[$673201]] -- Daemon Roar
