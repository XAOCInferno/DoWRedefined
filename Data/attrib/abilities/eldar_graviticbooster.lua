...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$92352]] -- - Increases speed, but reduces accuracy.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92353]] -- - Left-click to activate.  Left-click again to deactivate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$92354]] -- - Will remain on until turned off.
...
GameData["ui_info"]["screen_name_id"] = [[$92350]] -- Gravitic Booster
