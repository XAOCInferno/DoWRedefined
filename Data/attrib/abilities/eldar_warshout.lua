...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$92452]] -- - Banshee Exarch issues an ear-splitting battlecry.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92453]] -- - Left-click to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$92454]] -- - Causes massive morale damage to nearby enemy units.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$92455]] -- - Has no effect on units not affected by morale.
