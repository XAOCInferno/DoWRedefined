...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["min_damage"] = 4000
...
GameData["entity_busy_time"] = 2.170000076
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$674355]] -- - The Harlequin drives a hollow spike into her victim and deploys the monofilament wire inside it, killing the target instantly.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$674356]] -- - Causes splashes of boiling blood that injure surrounding units.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$674361]] -- - Left-click and target an enemy squad to activate.
...
GameData["ui_info"]["screen_name_id"] = [[$674354]] -- Harlequin's Kiss
