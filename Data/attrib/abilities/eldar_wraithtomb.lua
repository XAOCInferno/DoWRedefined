...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$92462]] -- - Encases enemy buildings in wraithbone.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$92463]] -- - Left-click and target an enemy building to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$92464]] -- - Targeted building cannot do anything for a short period of time, including producing units, performing research, etc.
...
GameData["ui_info"]["screen_name_id"] = [[$92460]] -- Wraithtomb
