...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$97622]] -- - Commander Unit (Primary).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$97623]] -- - Boosts morale recovery when attached to squads.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$97624]] -- - Ability upgrades provide attack bonuses for himself and troops.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$97625]] -- - Effective against all unit types. Excels at close combat.
