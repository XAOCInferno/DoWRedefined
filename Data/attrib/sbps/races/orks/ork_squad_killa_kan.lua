...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$97522]] -- - Walker Vehicle.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$97523]] -- - Support/Siege Unit. Most effective in close combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$97524]] -- - Can be upgraded with anti-vehicle ranged weaponry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$97525]] -- - Effective against most unit types, very effective against vehicles and buildings in close combat.
...
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$97520]] -- Killa Kan
