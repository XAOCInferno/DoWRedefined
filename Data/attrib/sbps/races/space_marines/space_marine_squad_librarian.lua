...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$97072]] -- - Commander Unit (Secondary).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$97073]] -- - Boosts morale recovery when attached to squads.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$97074]] -- - Psychic unit with many powerful abilities focused on weakening enemy resolve.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$97075]] -- - Effective against Infantry, Heavy Infantry, and Daemons. Excels at close combat.
...
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$97070]] -- Librarian
