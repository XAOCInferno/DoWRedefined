...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["addon_name"] = [[addons\eldar_aspect_stone_banshees.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$97774]] -- - Effective against Heavy Infantry.
