fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "FX4",
					type = "VARTYPE_STRING",
					value = "unit_librarian_hood_glow_4_ring",
				},
				property_04 =  
				{
					name = "FX5",
	...
	{
		effect = "root>unit_librarian_hood_glow_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>unit_librarian_hood_glow_2_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>unit_librarian_hood_glow_3_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>unit_librarian_hood_glow_4_ring",
		fx =  
		{
			properties =  
			{
