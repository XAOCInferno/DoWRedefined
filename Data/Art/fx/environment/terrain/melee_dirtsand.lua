fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "unit_melee_dust_cloud_spray",
				},
				property_01 =  
				{
					name = "Fx2",
	...
	{
		effect = "root>unit_melee_dust_cloud_spray",
		fx =  
		{
			properties =  
			{
				...
				property_13 =  
				{
					name = "Particle_Fx",
					type = "VARTYPE_STRING",
					value = "unit_melee_dust_cloud_ring",
				},
				property_14 =  
				{
	...
	{
		effect = "root>unit_melee_dust_cloud_spray>unit_melee_dust_cloud_ring",
		fx =  
		{
			properties =  
			{
