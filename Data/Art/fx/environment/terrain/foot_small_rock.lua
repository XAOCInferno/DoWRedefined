fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "unit_foot_dust_cloud_spray",
				},
				property_01 =  
				{
					name = "Fx2",
	...
	{
		effect = "root>unit_foot_dust_cloud_spray",
		fx =  
		{
			properties =  
			{
				...
				property_14 =  
				{
					name = "Particle_Fx",
					type = "VARTYPE_STRING",
					value = "unit_foot_dust_cloud_ring",
				},
				property_15 =  
				{
	...
	{
		effect = "root>unit_foot_dust_cloud_spray>unit_foot_dust_cloud_ring",
		fx =  
		{
			properties =  
			{
