fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				property_00 =  
				{
					name = "Fx1",
					type = "VARTYPE_STRING",
					value = "impact_unit_small_dust_cloud_spray",
				},
				property_01 =  
				{
					name = "Fx2",
	...
	{
		effect = "root>impact_unit_small_dust_cloud_spray",
		fx =  
		{
			properties =  
			{
				...
				property_13 =  
				{
					name = "Particle_Fx",
					type = "VARTYPE_STRING",
					value = "impact_unit_dust_cloud_ring",
				},
				property_14 =  
				{
	...
	{
		effect = "root>impact_unit_small_dust_cloud_spray>impact_unit_dust_cloud_ring",
		fx =  
		{
			properties =  
			{
