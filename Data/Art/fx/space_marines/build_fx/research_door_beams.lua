fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_01 =  
				{
					name = "Fx2",
					type = "VARTYPE_STRING",
					value = "temp_possession_ground_beam_spray",
				},
				property_02 =  
				{
					name = "FX3",
	...
	{
		effect = "root>temp_possession_ground_beam_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>temp_possession_ground_beam_spray>flame_line_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>temp_possession_ground_beam_spray>flame_line_combo>flame_line_beam",
		fx =  
		{
			properties =  
			{
