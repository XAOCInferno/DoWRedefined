fxtypes =  
{
	...
	{
		effect = "root>stun_unit>smite_energy_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "UNIT_FORCE_WEAPON_HIT2.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "UNIT_LIBRARIAN_HOOD_RING_4.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
