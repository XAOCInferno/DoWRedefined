fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_07 =  
				{
					name = "FX8",
					type = "VARTYPE_STRING",
					value = "muzzle_lascannon_dark_beam",
				},
			},
			style = "STYLE_COMBO",
		},
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/CHAOS_LASCANN_BIG_BEAM.TGA",
				},
				property_04 =  
				{
	...
	{
		effect = "root>muzzle_lascannon_combo>muzzle_lascannon_ring_2",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/CHAOS_LASCANNON_FLASH.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
		...
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/CHAOS_PLASMA_BEAM.TGA",
				},
				property_04 =  
				{
					name = "SelfIlluminated",
	...
	{
		effect = "root>muzzle_lascannon_combo>dark_outter_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/DARK_OUTER.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>muzzle_lascannon_combo>dark_outter_ring2",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>muzzle_lascannon_combo>dark_outter_ring3",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>muzzle_lascannon_combo>muzzle_lascannon_dark_beam",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "CHAOS/TEXTURES/CHAOS_LASCANNON_BEAM_DARK.TGA",
				},
				property_04 =  
				{
					name = "SelfIlluminated",
