fxtypes =  
{
	...
	{
		effect = "root>impact_frag_spark_ring_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>impact_frag_spark_ring_spray>impact_frag_spark_ring",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ENV_ORBITAL_GROUND_LIFT_DEBRIS.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>med_ash_burst>impact_frag_spark_ring",
		fx =  
		{
			properties =  
			{
