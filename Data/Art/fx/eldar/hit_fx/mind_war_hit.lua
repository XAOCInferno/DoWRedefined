fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "ELDAR/TEXTURES/D_CANNON_GROUND_RING_2.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>brain_spray>spark_ring_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>brain_spray>spark_ring_combo>spark_ring",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>brain_spray>spark_ring_combo>trail_hit",
		fx =  
		{
			properties =  
			{
