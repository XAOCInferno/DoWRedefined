fxtypes =  
{
	...
	{
		effect = "root>env_pod_smoke_l_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>env_pod_smoke_l_spray>env_pod_smoke_ring",
		fx =  
		{
			properties =  
			{
